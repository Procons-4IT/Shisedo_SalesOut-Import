...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            AddTables("Z_SODC", "Sell out data capture", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("Z_SODC", "Z_Date", "Date", SAPbobsCOM.BoFieldTypes.db_Date)
            AddFields("Z_SODC", "Z_Month", "Month", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("Z_SODC", "Z_Year", "Year", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("Z_SODC", "Z_BPCode", "Customer Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_SODC", "Z_ItemCode", "ItemCode", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            AddFields("Z_SODC", "Z_ItemName", "ItemName", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            AddFields("Z_SODC", "Z_Qty", "Quantity", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Quantity)
            AddFields("Z_SODC", "Z_Currency", "Currency", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            AddFields("Z_SODC", "Z_ExRate", "Exchange Rate", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Rate)
            AddFields("Z_SODC", "Z_Value", "Value", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_SODC", "Z_ValueLC", "Value in LC", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("Z_SODC", "Z_Stock", "Stock", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Quantity)
            'AddFields("Z_SODC", "Z_Passed", "Test Passed", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, 1)
            'AddFields("Z_SODC", "Z_Remarks", "Error Message", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)


            'AddTables("Z_SODC1", "Sell out data capture -Temp", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            'AddFields("Z_SODC1", "Z_Date", "Date", SAPbobsCOM.BoFieldTypes.db_Date)
            'AddFields("Z_SODC1", "Z_Month", "Month", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            'AddFields("Z_SODC1", "Z_Year", "Year", SAPbobsCOM.BoFieldTypes.db_Numeric)
            'AddFields("Z_SODC1", "Z_BPCode", "Customer Code", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            'AddFields("Z_SODC1", "Z_ItemCode", "ItemCode", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            'AddFields("Z_SODC1", "Z_ItemName", "ItemName", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            'AddFields("Z_SODC1", "Z_Qty", "Quantity", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Quantity)
            'AddFields("Z_SODC1", "Z_Currency", "Currency", SAPbobsCOM.BoFieldTypes.db_Alpha, , 10)
            'AddFields("Z_SODC1", "Z_ExRate", "Exchange Rate", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Price)
            'AddFields("Z_SODC1", "Z_Value", "Value", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("Z_SODC1", "Z_ValueLC", "Value in LC", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            'AddFields("Z_SODC1", "Z_Stock", "Stock", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Quantity)
            'AddFields("Z_SODC1", "Z_Passed", "Test Passed", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, 1)
            'AddFields("Z_SODC1", "Z_Remarks", "Error Message", SAPbobsCOM.BoFieldTypes.db_Alpha, , 200)
            '---- User Defined Object
            CreateUDO()
